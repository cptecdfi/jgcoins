...
unlocked to sign the Jgcoin-Qt.app bundle.
...
allowing somebody to distribute a Jgcoin-Qt.app or jgcoin-qt-setup.exe with a valid
...
that the jgcoin-qt.exe file inside the installer had not been tampered with.
