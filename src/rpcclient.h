...
#ifndef _JGCOINRPC_CLIENT_H_
#define _JGCOINRPC_CLIENT_H_ 1
...
/** Show help message for jgcoin-cli.
 ...
 *
 * @note the argument can be removed once jgcoin-cli functionality is removed from jgcoind
 */
