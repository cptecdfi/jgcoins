...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/jgcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Jgcoin"),
     ...
     * override -datadir in the jgcoin.conf file in the default data directory
     * (to be consistent with jgcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
