...
#ifndef H_JGCOIN_SCRIPT
#define H_JGCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CJgcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Jgcoin always counted CHECKMULTISIGs
