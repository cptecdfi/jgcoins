...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("jgcoin.sipa.be", "seed.jgcoin.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.jgcoin.dashjr.org"));
        vSeeds.push_back(CDNSSeedData("jgcoinstats.com", "seed.jgcoinstats.com"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("jgcoin.petertodd.org", "testnet-seed.jgcoin.petertodd.org"));
