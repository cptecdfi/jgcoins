#!/usr/bin/python
# Copyright (c) 2013 The Jgcoin Core developers
...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old JgcoinPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/JgcoindComparisonTool_jar/JgcoindComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/jgcoin/jgcoin.git")
...
environ_default("BUILD_PATH", "/mnt/jgcoin")
...
environ_default("GITHUB_REPO", "jgcoin/jgcoin")
