Jgcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/jgcoin/files/Jgcoin/jgcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Jgcoin
...
New/changed settings (command-line or jgcoin.conf file)
--------------------------------------------------------
