Jgcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/jgcoin/files/Jgcoin/jgcoin-0.5.4/
...
http://gitorious.org/jgcoin/jgcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Jgcoin-Qt notifications under Growl 1.3.
Increase required age of Jgcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxJgcoin properly when installing Jgcoin-Qt over it. (Windows)
