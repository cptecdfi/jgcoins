The following is a list of assets used in the jgcoin source and their proper attribution.
...
* License: MIT
* Site: [https://jgcointalk.org/index.php?topic=15276.0](https://jgcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original jgcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/jgcoin.icns, src/qt/res/src/jgcoin.svg,
	src/qt/res/src/jgcoin.ico, src/qt/res/src/jgcoin.png,
	src/qt/res/src/jgcoin_testnet.png, docs/jgcoin_logo_doxygen.png,
